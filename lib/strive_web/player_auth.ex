defmodule StriveWeb.PlayerAuth do
  ...
  def log_out_player(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      StriveWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  the current_player:
      ...
      defmodule StriveWeb.PageLive do
        use StriveWeb, :live_view

        on_mount {StriveWeb.PlayerAuth, :mount_current_player}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{StriveWeb.PlayerAuth, :ensure_authenticated}] do
